...
(function (require$$0, require$$0$1, antd) {
  ...
  function App() {
    ...
    const [songSheetList, setSongSheetList, getSongSheetList] = useLocalStorage("hifiti_song_sheet_list", []);
    ...
    const [curPlaySheet, setCurPlaySheet, getCurPlaySheet] = useLocalStorage("hifiti_save_play_sheet_name", "");
    const [saveSheetMusic, setSaveSheetMusic, getSaveSheetMusic] = useLocalStorage("hifiti_save_play_sheet_list", []);
